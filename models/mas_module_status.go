...
// MasModuleStatus represents the structure of the mas_module_status table
type MasModuleStatus struct {
...
func (MasModuleStatus) TableName() string {
	return "mas_module_status"
}
